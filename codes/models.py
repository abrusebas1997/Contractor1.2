...
class Code(models.Model):
    ...
    def get_absolute_url(self):
        """ Returns a fully-qualified path for a Code (/my-new-wiki-Code). """
        path_components = {'slug': self.slug}
        return reverse('wiki-details-Code', kwargs=path_components)
        # return reverse('wiki:wiki-update-Code', kwargs=path_components)
